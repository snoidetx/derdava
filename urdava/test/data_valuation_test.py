...
from urdava.model_utility import ICoalitionalValue
...
urdava_loo_value_independent_always = \
    valuable_model.valuate(data_valuation_function='robust loo',
                           coalition_probability=coalition_probability_independent_always)
assert is_close(urdava_loo_value_independent_always, loo_value), urdava_loo_value_independent_always
urdava_loo_value_independent_half = \
    valuable_model.valuate(data_valuation_function='robust loo',
                           coalition_probability=coalition_probability_independent_half)
assert is_close(urdava_loo_value_independent_half, {0: 1.75, 1: 1.25, 2: 0.75}), urdava_loo_value_independent_half
urdava_loo_value_independent_never = \
    valuable_model.valuate(data_valuation_function='robust loo',
                           coalition_probability=coalition_probability_independent_never)
assert is_close(urdava_loo_value_independent_never, dummy_value), urdava_loo_value_independent_never

# 012-MCMC URDaVa
urdava_shapley_value_independent_half = \
    valuable_model.valuate(data_valuation_function='robust shapley',
                           coalition_probability=coalition_probability_independent_half)
zot_mcmc_urdava_shapley_value_independent_half = \
    valuable_model.valuate(data_valuation_function='012-mcmc robust shapley',
                           coalition_probability=coalition_probability_independent_half,
                           tolerance=1.0005)
assert is_close(urdava_shapley_value_independent_half, zot_mcmc_urdava_shapley_value_independent_half), \
    (urdava_shapley_value_independent_half, zot_mcmc_urdava_shapley_value_independent_half)
